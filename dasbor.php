<?php    
    // menyertakan file dengan fungsi select data dari database
                ...
                <div class="col-6 mx-auto">
                    ...
                    <div class="card shadow bg-light text-secondary rounded-5">
                        ...
                        <div class="card-header text-center p-5">
                            <h1 class="display-1 fw-bolder text-primary">Welcome!</h1>
                            <p class="text-muted my-3">Anda sudah terdaftar sebagai anggota...</p>
                        </div>
                        <!-- .card-header end -->
                        ...
                        <div class="card-footer text-center py-5">
                            <a href="logout.php" class="fw-bold text-decoration-none btn btn-danger">Logout</a>
                        </div>
                        <!-- .card-footer end -->                        
